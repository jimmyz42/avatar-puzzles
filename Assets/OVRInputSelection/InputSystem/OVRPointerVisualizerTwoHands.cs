...
namespace ControllerSelection {
    ...
    public class OVRPointerVisualizerTwoHands : MonoBehaviour {
        ...
        [HideInInspector]
        public OVRInput.Controller activeController = OVRInputHelpers.GetControllerForButton(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.None);

        void Awake() {
            if (trackingSpace == null) {
                Debug.LogWarning("OVRPointerVisualizerTwoHands did not have a tracking space set. Looking for one");
